...
see https://github.com/susy-go/susy-graviton/issues/2040
Usage:

import (
 "github.com/susy-go/susy-graviton/common/httpclient"
 "github.com/susy-go/susy-graviton/swarm/api/http"
)
