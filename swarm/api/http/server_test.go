...
import (
	...
	"github.com/susy-go/susy-graviton/swarm/storage/feed/lookup"
	...
	swarm "github.com/susy-go/susy-graviton/swarm/api/client"
...
func TestBzzWithFeed(t *testing.T) {
	...
	// put togsophy some data for our test:
	dataBytes := []byte(`
	//
...
func TestBzzFeed(t *testing.T) {
	...
	topic, _ := feed.NewTopic("foo.sof", nil)
	updateRequest := feed.NewFirstRequest(topic)
...
func TestMultiPartUpload(t *testing.T) {
	...
	file2.Write([]byte("imaginsofisisjpegdata"))
	form.Close()
