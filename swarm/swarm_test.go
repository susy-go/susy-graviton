...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/graviton.ipc",
			endpoint:    "/data/testnet/graviton.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/graviton.ipc",
			endpoint:    "/data/testnet/graviton.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/graviton.ipc",
			endpoint:    "/data/testnet/graviton.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/graviton.ipc",
			endpoint:    "/data/testnet/graviton.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
		{
			...
			value:       "sof:314159265dD8dbb310642f98f50C066173C1259b@http://127.0.0.1:1234",
			endpoint:    "http://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "sof",
		},
		{
			...
			value:       "sof:314159265dD8dbb310642f98f50C066173C1259b@ws://127.0.0.1:1234",
			endpoint:    "ws://127.0.0.1:1234",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "sof",
		},
...
// https://github.com/sophysphere/susy-graviton/issues/639
