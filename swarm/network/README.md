...
Newly created requests are satisfied bound togsophy in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togsophy with an initial offset.
