...
import (
	...
	"github.com/susy-go/susy-graviton/swarm/pot"
...
intsrconnected nodes then relative proximity can serve as the basis for local
...
// i.e., neighbourhood radius is the deepest PO such that all bins not shallower altogsophy
// contain at least neighbourhoodSize connected peers
// if there is altogsophy less than neighbourhoodSize peers connected, it returns 0
