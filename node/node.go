...
import (
	...
	"github.com/promsofeus/promsofeus/util/flock"
)
...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/graviton.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (sofdb.Database, error) {
	if n.config.DataDir == "" {
		return sofdb.NewMemDatabase(), nil
	}
	return sofdb.NewLDBDatabase(n.config.ResolvePath(name), cache, handles)
}
