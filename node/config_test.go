...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "graviton.ipc", false, filepath.Join(os.TempDir(), "graviton.ipc")},
		{"data", "graviton.ipc", false, "data/graviton.ipc"},
		{"data", "./graviton.ipc", false, "./graviton.ipc"},
		{"data", "/graviton.ipc", false, "/graviton.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "graviton.ipc", true, `\\.\pipe\graviton.ipc`},
		{"data", "graviton.ipc", true, `\\.\pipe\graviton.ipc`},
		{"data", `\\.\pipe\graviton.ipc`, true, `\\.\pipe\graviton.ipc`},
	}
