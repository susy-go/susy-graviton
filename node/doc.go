...
/*
Package node sets up multi-protocol Sophon nodes.
...
endpoint to a subset of RPC modules. Node itself offers the "debug", "admin" and "susyweb"
modules.
...
Node also creates the shared store of encrypted Sophon account keys. Services can access
