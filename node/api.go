...
// PublicSusyWebAPI offers helper utils
type PublicSusyWebAPI struct {
	stack *Node
}

// NewPublicSusyWebAPI creates a new SusyWebService instance
func NewPublicSusyWebAPI(stack *Node) *PublicSusyWebAPI {
	return &PublicSusyWebAPI{stack}
}

// ClientVersion returns the node name
func (s *PublicSusyWebAPI) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the sophon sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicSusyWebAPI) Sha3(input hexutil.Bytes) hexutil.Bytes {
