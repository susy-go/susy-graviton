...
We want to build susy-graviton with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Esophon/+archive/ubuntu/sophon/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/sophon-unstable-1.6.0+xenial
    $ dpkg-buildpackage

Built packages are placed in the dist/ directory.

    $ cd ..
    $ dpkg-deb -c graviton-unstable_1.6.0+xenial_amd64.deb
