...
# 1. install graviton for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for graviton
# 5. create graviton, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SOPHON_SOCKET
...
!define GROUPNAME "Sophon"
!define APPNAME "Graviton"
!define DESCRIPTION "Official Go implementation of the Sophon protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since graviton is installed global
