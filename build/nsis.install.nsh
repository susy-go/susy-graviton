Name "graviton ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/susy-go/susy-graviton/issues"
!define UPDATEURL "https://github.com/susy-go/susy-graviton/releases"
!define ABOUTURL "https://github.com/susy-go/susy-graviton#sophon-go"
...
# Install graviton binary
Section "Graviton" GRAVITON_IDX
  SetOutPath $INSTDIR
  file {{.Graviton}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\graviton.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\graviton.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Graviton incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Graviton outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Graviton UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Graviton incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\graviton.exe" "" "" "Sophon" 30303 "" "" ""
  SimpleFC::AdvAddRule "Graviton outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\graviton.exe" "" "" "Sophon" "" 30303 "" ""
  SimpleFC::AdvAddRule "Graviton UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\graviton.exe" "" "" "Sophon" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/susy-go/SIPs/issues/147)
  ${EnvVarUpdate} $0 "SOPHON_SOCKET" "R" "HKLM" "\\.\pipe\graviton.ipc"
  ${EnvVarUpdate} $0 "SOPHON_SOCKET" "A" "HKLM" "\\.\pipe\graviton.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GRAVITON_IDX}
    SectionGetSize ${GRAVITON_IDX} $0
