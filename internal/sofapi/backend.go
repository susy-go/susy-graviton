...
// Package sofapi implements the general Sophon API functions.
package sofapi
...
type Backend interface {
	...
	RPCGasCap() *big.Int // global gas cap for sof_call over rpc: DoS protection
	...
	GetSVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header) (*vm.SVM, func() error, error)
	...
	return []rpc.API{
		{
			Namespace: "sof",
			Version:   "1.0",
			Service:   NewPublicSophonAPI(apiBackend),
			Public:    true,
		}, {
			Namespace: "sof",
			Version:   "1.0",
