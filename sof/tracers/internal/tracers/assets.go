...
func svmdis_tracerJs() (*asset, error) {
	bytes, err := svmdis_tracerJsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "svmdis_tracer.js", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	...
	"svmdis_tracer.js": svmdis_tracerJs,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"svmdis_tracer.js":   {svmdis_tracerJs, map[string]*bintree{}},
