...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (sof/61) or header (sof/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (sof/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both sof/61 and sof/62)
}
