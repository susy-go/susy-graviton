...
// Syncing provides information when this nodes starts synchronising with the Sophon network and when it's finished.
...
type SyncingResult struct {
	...
	Status  sophon.SyncProgress `json:"status"`
}
