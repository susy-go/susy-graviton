...
func newTestLDB() (*sofdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "sofdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := sofdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(sofdb.NewMemDatabase(), t)
}

func testPutGet(db sofdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(sofdb.NewMemDatabase(), t)
}

func testParallelPutGet(db sofdb.Database, t *testing.T) {
	const n = 8
