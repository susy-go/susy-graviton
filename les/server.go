...
func NewLesServer(sof *sof.Sophon, config *sof.Config) (*LesServer, error) {
	...
	srv := &LesServer{
		lesCommons: lesCommons{
			...
			chtIndexer:       light.NewChtIndexer(sof.ChainDb(), nil, params.CHTFrequency, params.HelperTrieProcessConfirmations),
	...
	srv.costTracker, srv.minCapacity = newCostTracker(sof.ChainDb(), config, requestLogger)
