...
func (req *TrieRequest) StoreResult(db sofdb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db sofdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db sofdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db sofdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db sofdb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db sofdb.Database) {
...
type TxStatus struct {
	...
	Lookup *rawdb.LegacyTxLookupEntry `srlp:"nil"`
	Error  string
}
...
// StoreResult stores the retrieved data in local database
func (req *TxStatusRequest) StoreResult(db sofdb.Database) {}
