...
func (db *NodeSet) Store(target sofdb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements sofdb.KeyValueWriter.
type NodeList []srlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db sofdb.KeyValueWriter) {
	for _, node := range n {
