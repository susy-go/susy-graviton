...
func (db *NodeSet) Store(target sofdb.Putter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements sofdb.Putter.
type NodeList []srlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db sofdb.Putter) {
	for _, node := range n {
