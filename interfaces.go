...
// Package sophon defines interfaces for interacting with Sophon.
package sophon
...
// the SVM but not mined into the blockchain. ContractCall is a low-level method to
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by sof_getLogs, return logs only from block with this hash
