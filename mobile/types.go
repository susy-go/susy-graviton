...
func NewHeaderFromRLP(data []byte) (*Header, error) {
	...
	if err := srlp.DecodeBytes(common.CopyBytes(data), h.header); err != nil {
		return nil, err
	}
	return h, nil
}
...
func (h *Header) EncodeRLP() ([]byte, error) {
	return srlp.EncodeToBytes(h.header)
}
...
func NewBlockFromRLP(data []byte) (*Block, error) {
	...
	if err := srlp.DecodeBytes(common.CopyBytes(data), b.block); err != nil {
		return nil, err
	}
	return b, nil
}
...
func (b *Block) EncodeRLP() ([]byte, error) {
	return srlp.EncodeToBytes(b.block)
}
...
// Transaction represents a single Sophon transaction.
...
func NewTransactionFromRLP(data []byte) (*Transaction, error) {
	...
	if err := srlp.DecodeBytes(common.CopyBytes(data), tx.tx); err != nil {
		return nil, err
	}
	return tx, nil
}
...
func (tx *Transaction) EncodeRLP() ([]byte, error) {
	return srlp.EncodeToBytes(tx.tx)
}
...
// Deprecated: use SophonClient.TransactionSender
func (tx *Transaction) GetFrom(chainID *BigInt) (address *Address, _ error) {
	var signer types.Signer = types.HomesteadSigner{}
	if chainID != nil {
		signer = types.NewSIP155Signer(chainID.bigint)
	}
...
func NewReceiptFromRLP(data []byte) (*Receipt, error) {
	...
	if err := srlp.DecodeBytes(common.CopyBytes(data), r.receipt); err != nil {
		return nil, err
	}
	return r, nil
}
...
func (r *Receipt) EncodeRLP() ([]byte, error) {
	return srlp.EncodeToBytes(r.receipt)
}
...
func (r *Receipt) EncodeJSON() (string, error) {
	data, err := srlp.EncodeToBytes(r.receipt)
	return string(data), err
}
