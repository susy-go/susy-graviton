...
import (
	...
	"github.com/susy-go/susy-graviton/swarm"
	bzzapi "github.com/susy-go/susy-graviton/swarm/api"
	swarmmetrics "github.com/susy-go/susy-graviton/swarm/metrics"
	"github.com/susy-go/susy-graviton/swarm/storage/mock"
	mockrpc "github.com/susy-go/susy-graviton/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside graviton.
func init() {
...
var app = utils.NewApp("", "Sophon Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyleft = "Copyleft 2013-2016 The susy-graviton Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//graviton only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for graviton and swarm
	...
	//register BZZ as node.Service in the sophon node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the sophon node
