...
import (
	...
	"github.com/susy-go/susy-graviton/signer/core"
	"github.com/susy-go/susy-graviton/signer/fourbyte"
	"github.com/susy-go/susy-graviton/signer/rules"
	"github.com/susy-go/susy-graviton/signer/storage"
...
without even the implied warranty of MSRCHANTABILITY or FITNESS FOR A PARTICULAR
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Sophon account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - clique header
		...
		cliqueRlp, err := srlp.EncodeToBytes(cliqueHeader)
		if err != nil {
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		srlpdata := common.FromHex("0xf85d640101948a8eafb1cf62bfbeb1741769dae1a9dd47996192018026a0716bd90515acb1e68e5ac5867aa11a1e65399c3349d479f5fb698554ebc6f293a04e8a4ebfff434e971e0ef12c5bf3a881b06fd04fc3f8b8a7291fb67a26a1d4ed")
		var tx types.Transaction
		srlp.DecodeBytes(srlpdata, &tx)
		add("OnApproved - SignTransactionResult", desc, &sofapi.SignTransactionResult{Raw: srlpdata, Tx: &tx})
