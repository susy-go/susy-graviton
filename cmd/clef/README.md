...
The signer will generate a new private key, encrypts it according to [susyweb keystore spec](https://github.com/susy-go/wiki/wiki/SusyWeb-Secret-Storage-Definition) and stores it in the keystore directory.
...
#### Import account
   Import a private key into the keystore. The imported key is expected to be encrypted according to the susyweb keystore
   format.
   
#### Arguments
  - account [object]: key in [susyweb keystore format](https://github.com/susy-go/wiki/wiki/SusyWeb-Secret-Storage-Definition) (retrieved with account_export) 
...
#### Result
  - exported key, see [susyweb keystore format](https://github.com/susy-go/wiki/wiki/SusyWeb-Secret-Storage-Definition) for
  more information
