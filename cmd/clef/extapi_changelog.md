...
* The external method `account_signTypedData` implements [SIP-712](https://github.com/susy-go/SIPs/blob/master/SIPS/sip-712.md) and makes it possible to sign typed data.
...
makes the `accounts_signTransaction` identical to the old `sof_signTransaction`.
