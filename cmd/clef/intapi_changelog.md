...
Changed the namespace format to adhere to the legacy sophon format: `name_methodName`. Changes:
...
* Add `ContentType` `string` to `SignDataRequest` to accommodate the latest SIP-191 and SIP-712 implementations.
