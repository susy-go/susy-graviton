...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 sof:1.0 sofash:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 shh:1.0 txpool:1.0 susyweb:1.0"
	httpAPIs = "sof:1.0 net:1.0 rpc:1.0 susyweb:1.0"
)
...
func TestConsoleWelcome(t *testing.T) {
	...
	graviton.SetTemplateFunc("gravitonver", func() string { return params.VersionWithMeta })
...
func testAttachWelcome(t *testing.T, graviton *testgraviton, endpoint, apis string) {
	...
	attach.SetTemplateFunc("gravitonver", func() string { return params.VersionWithMeta })
