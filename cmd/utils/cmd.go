...
func ImportPreimages(db *sofdb.LDBDatabase, fn string) error {
...
func ExportPreimages(db *sofdb.LDBDatabase, fn string) error {
	...
	for it.Next() {
		if err := srlp.Encode(writer, it.Value()); err != nil {
			return err
		}
	}
