...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db sofdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db sofdb.Database) error {
