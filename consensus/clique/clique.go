...
// ecrecover extracts the Sophon account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Sophon address
...
// Sophon testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     sofdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Sophon address of the signing key
...
func New(config *params.CliqueConfig, db sofdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Sophon address recovered
...
// CliqueRLP returns the srlp bytes which needs to be signed for the proof-of-authority
