...
//
// sof_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// sof_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.SofSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "sof_getBlockByNumber", "latest"); err != nil {
