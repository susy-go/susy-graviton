...
func TestHashStruct(t *testing.T) {
	...
	hash, err = typedData.HashStruct("SIP712Domain", typedData.Domain.Map())
	if err != nil {
		t.Error(err)
	}
...
func TestEncodeType(t *testing.T) {
	domainTypeEncoding := string(typedData.EncodeType("SIP712Domain"))
	if domainTypeEncoding != "SIP712Domain(string name,string version,uint256 chainId,address verifyingContract)" {
...
`
	...
	_, err = malformedDomainTypedData.HashStruct("SIP712Domain", malformedDomainTypedData.Domain.Map())
...
`
	...
	malformedTypedData.Types["SIP712Domain"][2].Type = "uint256"
...
`
	...
	_, err = malformedTypedData.HashStruct("SIP712Domain", malformedTypedData.Domain.Map())
	if err != nil {
