...
var (
	...
	sofashChainConfig *params.ChainConfig
...
func init() {
	...
	sofashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setSophybase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockSofash(t *testing.T) {
	testPendingStateAndBlock(t, sofashChainConfig, sofash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, sofdb.NewMemDatabase()))
}
...
func TestEmptyWorkSofash(t *testing.T) {
	testEmptyWork(t, sofashChainConfig, sofash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, sofdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	sofash := sofash.NewFaker()
	defer sofash.Close()

	w, b := newTestWorker(t, sofashChainConfig, sofash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockSofash(t *testing.T) {
	testRegenerateMiningBlock(t, sofashChainConfig, sofash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, sofdb.NewMemDatabase()))
}
...
func TestAdjustIntervalSofash(t *testing.T) {
	testAdjustInterval(t, sofashChainConfig, sofash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, sofdb.NewMemDatabase()))
}
