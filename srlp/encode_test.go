...
var encTests = []encTest{
	...
	{val: big.NewInt(-1), error: "srlp: cannot encode negative *big.Int"},
	...
	{val: testEncoder{}, error: "srlp: game over: unadressable value of type srlp.testEncoder, EncodeRLP is pointer method"},
