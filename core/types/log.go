...
// srlpStorageLog is the storage encoding of a log.
type srlpStorageLog srlpLog
...
func (l *Log) EncodeRLP(w io.Writer) error {
	return srlp.Encode(w, srlpLog{Address: l.Address, Topics: l.Topics, Data: l.Data})
}

// DecodeRLP implements srlp.Decoder.
func (l *Log) DecodeRLP(s *srlp.Stream) error {
	var dec srlpLog
	err := s.Decode(&dec)
	if err == nil {
...
func (l *LogForStorage) EncodeRLP(w io.Writer) error {
	return srlp.Encode(w, srlpStorageLog{
		Address: l.Address,
		Topics:  l.Topics,
		Data:    l.Data,
	})
...
func (l *LogForStorage) DecodeRLP(s *srlp.Stream) error {
	blob, err := s.Raw()
	if err != nil {
		return err
	}
	var dec srlpStorageLog
	err = srlp.DecodeBytes(blob, &dec)
	if err == nil {
		*l = LogForStorage{
			Address: dec.Address,
			Topics:  dec.Topics,
