...
func TestCall(t *testing.T) {
	state, _ := state.New(common.Hash{}, state.NewDatabase(sofdb.NewMemDatabase()))
...
func benchmarkSVM_Create(bench *testing.B, code string) {
	var (
		statedb, _ = state.New(common.Hash{}, state.NewDatabase(sofdb.NewMemDatabase()))
...
func BenchmarkSVM_CREATE_500(bench *testing.B) {
	// initcode size 500K, repeatedly calls CREATE and then modifies the mem contents
	benchmarkSVM_Create(bench, "5b6207a120600080f0600152600056")
}
func BenchmarkSVM_CREATE2_500(bench *testing.B) {
	// initcode size 500K, repeatedly calls CREATE2 and then modifies the mem contents
	benchmarkSVM_Create(bench, "5b586207a120600080f5600152600056")
}
func BenchmarkSVM_CREATE_1200(bench *testing.B) {
	// initcode size 1200K, repeatedly calls CREATE and then modifies the mem contents
	benchmarkSVM_Create(bench, "5b62124f80600080f0600152600056")
}
func BenchmarkSVM_CREATE2_1200(bench *testing.B) {
	// initcode size 1200K, repeatedly calls CREATE2 and then modifies the mem contents
	benchmarkSVM_Create(bench, "5b5862124f80600080f5600152600056")
}
