...
//
// Account references are used during SVM initialisation and
...
// Contract represents an sophon contract in the state database. It contains
...
// NewContract returns a new contract environment for the execution of SVM.
