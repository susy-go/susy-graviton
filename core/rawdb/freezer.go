...
//   reserving it for susy-graviton. This would also reduce the memory requirements
//   of Graviton, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db sofdb.KeyValueStore) {
