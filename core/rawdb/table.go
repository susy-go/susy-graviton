...
func NewTable(db sofdb.Database, prefix string) sofdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() sofdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) sofdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) sofdb.Iterator {
...
func (t *table) NewBatch() sofdb.Batch {
...
func (b *tableBatch) Replay(w sofdb.KeyValueWriter) error {
