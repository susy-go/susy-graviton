...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := sofdb.NewMemDatabase()
	finalDb := sofdb.NewMemDatabase()
...
// https://github.com/susy-go/susy-graviton/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(sofdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(sofdb.NewMemDatabase()))
...
// See https://github.com/susy-go/susy-graviton/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(sofdb.NewMemDatabase()))
