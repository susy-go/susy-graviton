...
// account array.
func checkStateAccounts(t *testing.T, db sofdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db sofdb.Database, root common.Hash) error {
...
func checkStateConsistency(db sofdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, sofdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(sofdb.Database), srcRoot)
