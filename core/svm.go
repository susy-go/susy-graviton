...
// NewSVMContext creates a new context for use in the SVM.
func NewSVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
