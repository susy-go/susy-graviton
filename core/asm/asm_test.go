...
// Tests disassembling the instructions for valid svm code
...
// Tests disassembling the instructions for invalid svm code
...
// Tests disassembling the instructions for empty svm code
