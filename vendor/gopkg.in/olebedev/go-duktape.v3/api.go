...
static duk_bool_t _duk_is_object_cosrcible(duk_context *ctx, duk_idx_t index) {
	return duk_is_object_cosrcible(ctx, index);
}
...
static void _duk_require_object_cosrcible(duk_context *ctx, duk_idx_t index) {
	duk_require_object_cosrcible(ctx, index);
}
...
// See: http://duktape.org/api.html#duk_is_object_cosrcible
func (d *Context) IsObjectCosrcible(index int) bool {
	return int(C._duk_is_object_cosrcible(d.duk_context, C.duk_idx_t(index))) == 1
}
...
// See: http://duktape.org/api.html#duk_require_object_cosrcible
func (d *Context) RequireObjectCosrcible(index int) {
	C._duk_require_object_cosrcible(d.duk_context, C.duk_idx_t(index))
}
