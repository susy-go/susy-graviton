...
const (
	...
	SYS_GETRLIMIT     = 194 // { int getrlimit(u_int which, struct rlimit *srlp); } getrlimit __getrlimit_args int
	SYS_SETRLIMIT     = 195 // { int setrlimit(u_int which, struct rlimit *srlp); } setrlimit __setrlimit_args int
