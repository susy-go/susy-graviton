...
//
// Keys are stored as encrypted JSON files according to the SusyWeb Secret Storage specification.
// See https://github.com/susy-go/wiki/wiki/SusyWeb-Secret-Storage-Definition for more information.
package keystore
...
func (ks *KeyStore) SignTx(a accounts.Account, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	// Depending on the presence of the chain ID, sign with SIP155 or homestead
	if chainID != nil {
		return types.SignTx(tx, types.NewSIP155Signer(chainID), unlockedKey.PrivateKey)
	}
...
func (ks *KeyStore) SignTxWithPassphrase(a accounts.Account, passphrase string, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	// Depending on the presence of the chain ID, sign with SIP155 or homestead
	if chainID != nil {
		return types.SignTx(tx, types.NewSIP155Signer(chainID), key.PrivateKey)
	}
...
// ImportPreSaleKey decrypts the given Sophon presale wallet and stores
