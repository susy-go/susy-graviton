...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/susy-go/pysofsaletool

		pysofsaletool generates the encryption key from password by
	...
	*/
	...
	sofPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(sofPriv)
	...
	expectedAddr := preSaleKeyStruct.SofAddr
