...
// Package accounts implements high level Sophon account management.
package accounts
...
// Account represents an Sophon account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Sophon account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain sophon.ChainStateReader)
