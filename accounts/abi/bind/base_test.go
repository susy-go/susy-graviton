...
func (mc *mockCaller) CallContract(ctx context.Context, call sophon.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func TestUnpackIndexedSliceTyLogIntoMap(t *testing.T) {
	sliceBytes, err := srlp.EncodeToBytes([]string{"name1", "name2", "name3", "name4"})
	if err != nil {
		t.Fatal(err)
	}
...
func TestUnpackIndexedArrayTyLogIntoMap(t *testing.T) {
	arrBytes, err := srlp.EncodeToBytes([2]common.Address{common.HexToAddress("0x0"), common.HexToAddress("0x376c47978271565f56DEB45495afa69E59c16Ab2")})
	if err != nil {
		t.Fatal(err)
	}
