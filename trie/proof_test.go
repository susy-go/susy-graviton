...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *sofdb.MemDatabase {
	var provers []func(key []byte) *sofdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *sofdb.MemDatabase {
		proof := sofdb.NewMemDatabase()
