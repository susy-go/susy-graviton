...
type Database struct {
	diskdb sofdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb sofdb.Database) *Database {
...
func NewDatabaseWithCache(diskdb sofdb.Database, cache int) *Database {
...
func (db *Database) commit(hash common.Hash, batch sofdb.Batch) error {
