...
// Package chequebook package wraps the 'chequebook' Sophon smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in sophy; (auto)cashing cheques in sophy
// as well as (auto)depositing sophy to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/susy-go/susy-graviton/contracts/chequebook/contract"
	"github.com/susy-go/susy-graviton/core/types"
	"github.com/susy-go/susy-graviton/crypto"
	"github.com/susy-go/susy-graviton/log"
	"github.com/susy-go/susy-graviton/swarm/services/swap/swap"
)
...
// * depositing sophy to the chequebook
// * watching incoming sophy
...
// Cash cashes the cheque by sending an Sophon transaction.
