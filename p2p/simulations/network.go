...
// starting nodes and connecting them togsophy.
//
...
// Connect connects two nodes togsophy by calling the "admin_addPeer" RPC
...
func (n *Node) UnmarshalJSON(raw []byte) error {
	...
	// Ticket: https://github.com/sophysphere/susy-graviton/issues/1177
	node := struct {
		Config *adapters.NodeConfig `json:"config,omitempty"`
		Up     bool                 `json:"up"`
	}{}
