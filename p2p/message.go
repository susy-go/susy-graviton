...
//
// For the decoding rules, please see package srlp.
func (msg Msg) Decode(val interface{}) error {
	s := srlp.NewStream(msg.Payload, uint64(msg.Size))
...
func Send(w MsgWriter, msgcode uint64, data interface{}) error {
	size, r, err := srlp.EncodeToReader(data)
	if err != nil {
		return err
	}
...
func ExpectMsg(r MsgReader, code uint64, content interface{}) error {
	...
	contentEnc, err := srlp.EncodeToBytes(content)
	if err != nil {
