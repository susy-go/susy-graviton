...
// Package p2p implements the Sophon p2p network protocols.
package p2p
...
import (
	...
	"github.com/susy-go/susy-graviton/p2p/discover"
	"github.com/susy-go/susy-graviton/p2p/discv5"
	"github.com/susy-go/susy-graviton/p2p/enode"
	"github.com/susy-go/susy-graviton/p2p/enr"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "sophon discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "sophon p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Sophon Node Record
...
func (srv *Server) NodeInfo() *NodeInfo {
	...
	if enc, err := srlp.EncodeToBytes(node.Record()); err == nil {
