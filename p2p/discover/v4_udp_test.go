...
import (
	...
	"github.com/susy-go/susy-graviton/internal/testlog"
...
var testPackets = []struct {
	...
	},
	{
		...
		wantPacket: &pingV4{
			...
			Expiration: 1136239445,
			Rest:       []srlp.RawValue{{0xC5, 0x01, 0x02, 0x03, 0x04, 0x05}},
		},
	},
	{
		...
		wantPacket: &pongV4{
			...
			Expiration: 1136239445,
			Rest:       []srlp.RawValue{{0xC6, 0x01, 0x02, 0x03, 0xC2, 0x04, 0x05}, {0x06}},
		},
	},
	{
		...
		wantPacket: &findnodeV4{
			...
			Expiration: 1136239445,
			Rest:       []srlp.RawValue{{0x82, 0x99, 0x99}, {0x83, 0x99, 0x99, 0x99}},
		},
	},
	{
		...
		wantPacket: &neighborsV4{
			...
			Expiration: 1136239445,
			Rest:       []srlp.RawValue{{0x01}, {0x02}, {0x03}},
		},
	},
}
